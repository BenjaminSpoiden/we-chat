...
export const FriendRequestSidebarOption: React.FC<FriendRequestSidebarProps> = ({
    ...
    return (
        <Link href="/dashboard/requests" className="text-slate-700 hover:text-indigo-600 hover:bg-slate-300 group flex items-center gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
